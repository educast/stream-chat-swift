...
///
/// The function always uses the latest request `RequestRecorderURLProtocolMock` records. If no request has
...
func AssertNetworkRequest(
    ...
    guard let request = RequestRecorderURLProtocolMock.waitForRequest(timeout: timeout) else {
