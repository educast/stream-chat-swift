...
extension StreamMockServer {
    ...
    func mockMessageWithReaction(
        ...
        if deleted {
            ...
            var latest_reactions =
                mockedMessage[MessagePayloadsCodingKeys.latestReactions.rawValue] as! Array<[String: Any]>
            var reaction_counts =
            ...
            newReaction["message_id"] = messageId
            newReaction["type"] = reactionType
            newReaction["score"] = 1
            newReaction["created_at"] = timestamp
            newReaction["updated_at"] = timestamp
            newReaction["enforce_unique"] = false
    ...
    private func reactionResponse(
        ...
        let messageDetails = findMessage(id: messageId)
